...
partial = template.partial(role="python开发") #部分填充，这里还是<class 'langchain_core.prompts.prompt.PromptTemplate'>
...
prompt = partial.format(question="冒泡排序怎么写？") #调用format才是string类型转换
