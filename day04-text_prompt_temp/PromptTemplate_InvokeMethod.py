"""
day03-invoke() 是 LangChain Expression Language（LCEL 的统一执行入口，用于执行任意可运行对象（Runnable ）。返回的是一个 PromptValue 对象，
...
# 打印PromptValue对象及其类型
print(prompt)   #text='你是一个专业的python开发工程师，请回答我的问题给出回答，我的问题是：冒泡排序怎么写？'
...
#转为消息列表的形式,<class 'list'>
print(prompt.to_messages())  #[HumanMessage(content='你是一个专业的python开发工程师，请回答我的问题给出回答，我的问题是：冒泡排序怎么写？', additional_kwargs={}, response_metadata={})]

print(type(prompt.to_messages())) #<class 'list'>



# invoke方法传入一个参数，就是变量的字典对象
